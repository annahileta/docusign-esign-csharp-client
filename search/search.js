...
function SearchBox(name, resultsPath, inFrame, label) {
  ...
  this.OnSearchSelectHide = function () {
    this.hideTimeout = setTimeout(
      this.name + '.CloseSelectionWindow()',
  ...
  this.OnSearchFieldChange = function (evt) {
    ...
    if (e.keyCode == 40 || e.keyCode == 13) {
      ...
      // Escape out of the search field
  ...
  this.OnSelectItem = function (id) {
    ...
    var searchValue = this.DOMSearchField().value.replace(/ +/g, '');
    if (searchValue != '' && this.searchActive) {
  ...
  this.Search = function () {
    ...
    if (0xd800 <= code && code <= 0xdbff && searchValue > 1) {
      // surrogate pair
    ...
    if (idx != -1) {
      ...
      hasResultsPage = true;
    } // nothing available for this search term
    else {
...
function SearchResults(name) {
  ...
  this.NavNext = function (index) {
    ...
    while (1) {
      ...
      if (
        focusItem &&
        focusItem.parentNode.parentNode.style.display == 'block'
      ) {
        break;
      } else if (!focusItem) {
        // last element
  ...
  this.NavChild = function (evt, itemIndex, childIndex) {
    ...
    if (this.lastKey == 38) {
      ...
      } // already at first child, jump to parent
      else {
...
function createResults() {
  ...
  for (var e = 0; e < searchData.length; e++) {
    ...
    if (searchData[e][1].length == 2) {
      ...
      srLink.setAttribute(
        'href',
        'javascript:searchResults.Toggle("SR_' + id + '")',
      );
      ...
      for (var c = 0; c < searchData[e][1].length - 1; c++) {
        ...
        setKeyActions(
          srChild,
          'return searchResults.NavChild(event,' + e + ',' + c + ')',
        );
