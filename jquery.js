...
(function (bb, L) {
    ...
    bF.fn = bF.prototype = {
      ...
      slice: function () {
        return this.pushStack(
          ...
          'slice',
          bK.call(arguments).join(','),
        );
      },
      map: function (b0) {
        return this.pushStack(
          bF.map(this, function (b2, b1) {
    ...
    bF.extend({
      ...
      isPlainObject: function (b2) {
        ...
        try {
          if (
            ...
            !bG.call(b2.constructor.prototype, 'isPrototypeOf')
          ) {
            return false;
          }
        } catch (b1) {
      ...
      trim: bO
        ...
        : function (b0) {
            return b0 == null
              ? ''
              : b0.toString().replace(bI, '').replace(bE, '');
          },
      ...
      map: function (b0, b7, b8) {
        var b5,
          ...
          b3 =
            ...
            (b1 !== L &&
              typeof b1 === 'number' &&
              ((b1 > 0 && b0[0] && b0[b1 - 1]) || b1 === 0 || bF.isArray(b0)));
        if (b3) {
          for (; b2 < b1; b2++) {
            b5 = b7(b0[b2], b2, b8);
            if (b5 != null) {
  ...
  b.extend({
    Deferred: function (by) {
      var bx = b.Callbacks('once memory'),
        ...
        e = 'pending',
        bA = { resolve: bx, reject: bw, notify: bv },
        bC = {
          done: bx.add,
          fail: bw.add,
          progress: bv.add,
  ...
  b.support = (function () {
    ...
    bJ = {
      ...
      html5Clone:
        av.createElement('nav').cloneNode(true).outerHTML !== '<:nav></:nav>',
      submitBubbles: true,
      changeBubbles: true,
    ...
    if (bb.getComputedStyle) {
      ...
      bv.style.width = '2px';
      bv.appendChild(bA);
      bJ.reliableMarginRight =
        (parseInt(
          (bb.getComputedStyle(bA, null) || { marginRight: 0 }).marginRight,
          10,
        ) || 0) === 0;
    }
    if (bv.attachEvent) {
    ...
    b(function () {
      ...
      bM.style.cssText =
        bR + 'width:0;height:0;position:static;top:0;margin-top:' + bL + 'px';
  ...
  b.fn.extend({
    ...
    promise: function (bD, bw) {
      ...
      while (by--) {
        if (
          (bx =
            b.data(bv[by], bz, L, true) ||
            ((b.data(bv[by], bA, L, true) || b.data(bv[by], bC, L, true)) &&
              b.data(bv[by], bz, b.Callbacks('once memory'), true)))
        ) {
          bB++;
          bx.add(bE);
        }
  ...
  b.fn.extend({
    ...
    hasClass: function (e) {
      ...
      for (; bw < bv; bw++) {
        if (
          this[bw].nodeType === 1 &&
          (' ' + this[bw].className + ' ').replace(aP, ' ').indexOf(bx) > -1
        ) {
          return true;
        }
      }
        ...
        get: function (e) {
          ...
          for (; bv < bz; bv++) {
            ...
            if (
              ...
              (!bx.parentNode.disabled ||
                !b.nodeName(bx.parentNode, 'optgroup'))
            ) {
              bA = b(bx).val();
              if (bw) {
                return bA;
      ...
      tabIndex: {
        get: function (bv) {
          ...
          return e && e.specified
            ? parseInt(e.value, 10)
            : D.test(bv.nodeName) || (l.test(bv.nodeName) && bv.href)
            ? 0
            : L;
        },
      },
  ...
  if (!F) {
    aF = { name: true, id: true };
    be = b.valHooks.button = {
      get: function (bw, bv) {
        var e;
        e = bw.getAttributeNode(bv);
        return e && (aF[bv] ? e.nodeValue !== '' : e.specified)
          ? e.nodeValue
          : L;
      },
  ...
  var bd = /^(?:textarea|input|select)$/i,
    ...
    j = function (bw, e) {
      ...
      return (
        (!e[1] || bw.nodeName.toLowerCase() === e[1]) &&
        (!e[2] || (bv.id || {}).value === e[2]) &&
        (!e[3] || e[3].test((bv['class'] || {}).value))
      );
    },
    bt = function (e) {
      return b.event.special.hover
        ? e
        : e.replace(J, 'mouseenter$1 mouseleave$1');
    };
  b.event = {
      ...
      if (!bB) {
        bD.handle = bB = function (bL) {
          return typeof b !== 'undefined' &&
            (!bL || b.event.triggered !== bL.type)
            ? b.event.dispatch.apply(bB.elem, arguments)
            : L;
        };
        bB.elem = bx;
      }
      ...
      for (bF = 0; bF < bE.length; bF++) {
        ...
        for (bG = 0; bG < bD.length; bG++) {
          ...
          if (
            ...
            (!bH || bH === e.selector || (bH === '**' && e.selector))
          ) {
            bD.splice(bG--, 1);
            if (e.selector) {
              bD.delegateCount--;
    ...
    trigger: function (bv, bD, bA, bJ) {
      ...
      if (!bJ && !bv.isDefaultPrevented()) {
        if (
          (!bF._default || bF._default.apply(bA.ownerDocument, bD) === false) &&
    ...
    dispatch: function (e) {
      ...
      if (bA && !e.target.disabled && !(e.button && e.type === 'click')) {
        ...
        for (bK = e.target; bK != this; bK = bK.parentNode || this) {
          ...
          if (bD.length) {
            bH.push({ elem: bK, matches: bD });
          }
        }
      }
      if (bz.length > bA) {
        bH.push({ elem: this, matches: bz.slice(bA) });
      }
      for (bC = 0; bC < bH.length && !e.isPropagationStopped(); bC++) {
        ...
        for (
          bB = 0;
          bB < bv.matches.length && !e.isImmediatePropagationStopped();
          bB++
        ) {
          bI = bv.matches[bB];
          if (
            by ||
            (!e.namespace && !bI.namespace) ||
            (e.namespace_re && e.namespace_re.test(bI.namespace))
          ) {
            e.data = bI.data;
            e.handleObj = bI;
            bF = (
              (b.event.special[bI.origType] || {}).handle || bI.handler
            ).apply(bv.elem, bG);
            if (bF !== L) {
              e.result = bF;
              if (bF === false) {
  ...
  b.Event = function (bv, e) {
    ...
    if (bv && bv.type) {
      ...
      this.isDefaultPrevented =
        ...
        (bv.getPreventDefault && bv.getPreventDefault())
          ? i
          : bk;
    } else {
      this.type = bv;
    ...
    b.event.special.submit = {
      setup: function () {
        ...
        b.event.add(this, 'click._submit keypress._submit', function (bx) {
          var bw = bx.target,
            bv =
              b.nodeName(bw, 'input') || b.nodeName(bw, 'button') ? bw.form : L;
    ...
    off: function (bw, e, by) {
      if (bw && bw.preventDefault && bw.handleObj) {
        ...
        b(bw.delegateTarget).off(
          bv.namespace ? bv.type + '.' + bv.namespace : bv.type,
          bv.selector,
          bv.handler,
        );
        return this;
  ...
  (function () {
          ...
          if (e && e.nodeType === 1) {
            for (bX = 0; b6[bX] != null; bX++) {
              if (
                b6[bX] &&
                (b6[bX] === true ||
                  (b6[bX].nodeType === 1 && by.contains(e, b6[bX])))
              ) {
                bY.push(b3[bX]);
              }
            }
        ...
        '+': function (bW, bR) {
          ...
          for (var bS = 0, e = bW.length, bU; bS < e; bS++) {
            if ((bU = bW[bS])) {
              ...
              bW[bS] =
                bX || (bU && bU.nodeName.toLowerCase() === bR)
                  ? bU || false
                  : bU === bR;
            }
          }
      ...
      filter: {
        PSEUDO: function (bS, bX, bW, bY) {
          ...
          if (bR) {
            ...
            if (e === 'contains') {
              return (
                (bS.textContent || bS.innerText || bw([bS]) || '').indexOf(
                  bX[3],
                ) >= 0
              );
            } else {
        ...
        TAG: function (bR, e) {
          return (
            (e === '*' && bR.nodeType === 1) ||
            (!!bR.nodeName && bR.nodeName.toLowerCase() === e)
          );
        },
        CLASS: function (bR, e) {
          return (
            (' ' + (bR.className || bR.getAttribute('class')) + ' ').indexOf(
              e,
            ) > -1
          );
        },
        ATTR: function (bV, bT) {
          ...
          return e == null
            ...
            ? bW.indexOf(bR) === 0
            : bU === '$='
            ? bW.substr(bW.length - bR.length) === bR
            : bU === '|='
            ? bW === bR || bW.substr(0, bR.length + 1) === bR + '-'
            : false;
        },
    ...
    for (var bz in bE.match) {
      bE.match[bz] = new RegExp(
        bE.match[bz].source + /(?![^\[]*\])(?![^\(]*\))/.source,
      );
      bE.leftMatch[bz] = new RegExp(
    ...
    (function () {
      ...
      if (av.getElementById(bS)) {
            ...
            return bT
              ? bT.id === bU[1] ||
                (typeof bT.getAttributeNode !== 'undefined' &&
                  bT.getAttributeNode('id').nodeValue === bU[1])
                ? [bT]
                : L
              : [];
          }
        ...
        bE.filter.ID = function (bV, bT) {
          var bU =
            typeof bV.getAttributeNode !== 'undefined' &&
  ...
  var ab = /Until$/,
    ...
    H = b.expr.match.POS,
    ay = { children: true, contents: true, next: true, prev: true };
  b.fn.extend({
    find: function (e) {
      var bw = this,
        by,
    ...
    closest: function (by, bx) {
      ...
      var bA =
        H.test(by) || typeof by !== 'string' ? b(by, bx || this.context) : 0;
    ...
    text: function (e) {
      ...
      if (typeof e !== 'object' && e !== L) {
        return this.empty().append(
          ((this[0] && this[0].ownerDocument) || av).createTextNode(e),
        );
      }
      return b.text(this);
    },
    ...
    html: function (bx) {
      if (bx === L) {
        return this[0] && this[0].nodeType === 1
          ? this[0].innerHTML.replace(ag, '')
          : null;
      } else {
        if (
          typeof bx === 'string' &&
          !ae.test(bx) &&
          (b.support.leadingWhitespace || !ar.test(bx)) &&
          !ax[(d.exec(bx) || ['', ''])[1].toLowerCase()]
        ) {
          bx = bx.replace(R, '<$1></$2>');
          try {
      ...
      if (this[0]) {
        ...
        if (by) {
          ...
          for (var bw = 0, e = this.length, bz = e - 1; bw < e; bw++) {
            bE.call(
              bF ? ba(this[bw], by) : this[bw],
              bx.cacheable || (e > 1 && bw < bz) ? b.clone(bA, true, true) : bA,
            );
          }
        }
        if (bv.length) {
    ...
    if (bw) {
      ...
      for (by in bw) {
        for (bx = 0, e = bw[by].length; bx < e; bx++) {
          b.event.add(
            bv,
            by + (bw[by][bx].namespace ? '.' : '') + bw[by][bx].namespace,
            bw[by][bx],
            bw[by][bx].data,
          );
        }
  ...
  b.buildFragment = function (bz, bx, bv) {
    ...
    if (
      ...
      (b.support.html5Clone || !ah.test(bB))
    ) {
      e = true;
      bw = b.fragments[bB];
      if (bw && bw !== 1) {
  ...
  b.extend({
    clone: function (by, bA, bw) {
      var e,
        ...
        bx,
        bz =
          b.support.html5Clone || !ah.test('<' + by.nodeName)
            ? by.cloneNode(true)
            : al(by);
      if (
    ...
    clean: function (bw, by, bH, bA) {
          ...
          if (!W.test(bz)) {
            ...
            if (!b.support.tbody) {
              var e = w.test(bz),
                bC =
                  bK === 'table' && !e
                    ? bv.firstChild && bv.firstChild.childNodes
                    : bx[1] === '<table>' && !e
                    ? bv.childNodes
                    : [];
      ...
      if (bH) {
        ...
        for (bE = 0; bI[bE]; bE++) {
          if (
            bA &&
            b.nodeName(bI[bE], 'script') &&
            (!bI[bE].type || bI[bE].type.toLowerCase() === 'text/javascript')
          ) {
            bA.push(
              bI[bE].parentNode
                ? bI[bE].parentNode.removeChild(bI[bE])
                : bI[bE],
            );
          } else {
            if (bI[bE].nodeType === 1) {
  ...
  function bo(e, bv) {
    if (bv.src) {
      ...
      b.globalEval(
        (bv.text || bv.textContent || bv.innerHTML || '').replace(aN, '/*$0*/'),
      );
    }
    if (bv.parentNode) {
  ...
  var ak = /alpha\([^)]*\)/i,
    ...
    bn = /^-?\d/,
    I = /^([\-+])=([\-+.\de]+)/,
    a7 = { position: 'absolute', visibility: 'hidden', display: 'block' },
    an = ['Left', 'Right'],
    a1 = ['Top', 'Bottom'],
    Z,
    aI,
  ...
  if (!b.support.opacity) {
    b.cssHooks.opacity = {
      get: function (bv, e) {
        return au.test(
          (e && bv.currentStyle ? bv.currentStyle.filter : bv.style.filter) ||
            '',
        )
  ...
  if (av.defaultView && av.defaultView.getComputedStyle) {
    aI = function (by, bw) {
      ...
      if (
        (bx = by.ownerDocument.defaultView) &&
        (e = bx.getComputedStyle(by, null))
      ) {
    ...
    b.expr.filters.hidden = function (bw) {
      ...
      return (
        ...
        (!b.support.reliableHiddenOffsets &&
          ((bw.style && bw.style.display) || b.css(bw, 'display')) === 'none')
      );
    };
      ...
      return this.map(function () {
        ...
        .filter(function () {
          return (
            this.name &&
            !this.disabled &&
            (this.checked || q.test(this.nodeName) || aZ.test(this.type))
          );
        })
        .map(function (e, bv) {
          var bw = b(this).val();
    ...
    ajax: function (bz, bx) {
      ...
      if (!bD.hasContent) {
        ...
        if (bD.cache === false) {
          ...
          bD.url =
            bP +
            (bP === bD.url ? (M.test(bD.url) ? '&' : '?') + '_=' + bv : '');
        }
      }
      if (
        (bD.data && bD.hasContent && bD.contentType !== false) ||
        bx.contentType
      ) {
      ...
      bJ.setRequestHeader(
        'Accept',
        bD.dataTypes[0] && bD.accepts[bD.dataTypes[0]]
          ? bD.accepts[bD.dataTypes[0]] +
              (bD.dataTypes[0] !== '*' ? ', ' + aV + '; q=0.01' : '')
          : bD.accepts['*'],
      );
      ...
      b.each(by, function (bA, bz) {
        if (bv || ap.test(bw)) {
          ...
          v(
            bw +
              '[' +
              (typeof bz === 'object' || b.isArray(bz) ? bA : '') +
              ']',
            bz,
            bv,
            bx,
  ...
  b.ajaxPrefilter('json jsonp', function (bD, bA, bC) {
    var bx =
      bD.contentType === 'application/x-www-form-urlencoded' &&
      typeof bD.data === 'string';
    if (
      bD.dataTypes[0] === 'jsonp' ||
      (bD.jsonp !== false && (u.test(bD.url) || (bx && u.test(bD.data))))
    ) {
      var bB,
        bw = (bD.jsonpCallback = b.isFunction(bD.jsonpCallback)
          ? bD.jsonpCallback()
          : bD.jsonpCallback),
        bz = bb[bw],
        e = bD.url,
  ...
  b.ajaxTransport('script', function (bw) {
    if (bw.crossDomain) {
      var e,
        bv =
          av.head || av.getElementsByTagName('head')[0] || av.documentElement;
      return {
        send: function (bx, by) {
      ...
      function bv() {
        ...
        for (bD in bz) {
          ...
          if (b.isArray(bF)) {
            ...
            bE.animatedProperties[bB] =
              (bE.specialEasing && bE.specialEasing[bB]) ||
              bE.easing ||
              'swing';
          }
    ...
    if (!Q[bx]) {
      ...
      if (bw === 'none' || bw === '') {
        ...
        if (!m || !a8.createElement) {
          ...
          m.write(
            (av.compatMode === 'CSS1Compat' ? '<!doctype html>' : '') +
              '<html><body>',
          );
          m.close();
        }
  ...
  if ('getBoundingClientRect' in av.documentElement) {
    b.fn.offset = function (bI) {
      ...
      var bC = bH.body,
        ...
        bv =
          bD.pageYOffset ||
          (b.support.boxModel && bw.scrollTop) ||
          bC.scrollTop,
        bz =
          bD.pageXOffset ||
          (b.support.boxModel && bw.scrollLeft) ||
          bC.scrollLeft,
        bG = bB.top + bv - bA,
        bx = bB.left + bz - bE;
      ...
      while ((bz = bz.parentNode) && bz !== bA && bz !== bx) {
        ...
        if (bz === bw) {
          ...
          if (
            ...
            !(b.support.doesAddBorderForTableAndCells && V.test(bz.nodeName))
          ) {
  ...
  b.offset = {
    ...
    setOffset: function (bx, bG, bA) {
      ...
      var bz = b(bx),
        ...
        bE = b.css(bx, 'left'),
        bF =
          (bB === 'absolute' || bB === 'fixed') &&
          b.inArray('auto', [e, bE]) > -1,
        bD = {},
        bC = {},
        bw,
        by;
  ...
  b.each(['Left', 'Top'], function (bv, e) {
    ...
    b.fn[bw] = function (bz) {
      ...
      if (bz === L) {
        ...
        return by
          ? 'pageXOffset' in by
            ? by[bv ? 'pageYOffset' : 'pageXOffset']
            : (b.support.boxModel && by.document.documentElement[bw]) ||
              by.document.body[bw]
          : bx[bw];
      }
      return this.each(function () {
        ...
        if (by) {
          by.scrollTo(
            !bv ? bz : b(by).scrollLeft(),
            bv ? bz : b(by).scrollTop(),
          );
        } else {
          this[bw] = bz;
        }
  ...
  b.each(['Height', 'Width'], function (bv, e) {
    ...
    b.fn['inner' + e] = function () {
      ...
      return bx
        ? bx.style
          ? parseFloat(b.css(bx, bw, 'padding'))
          : this[bw]()
        : null;
    };
    b.fn['outer' + e] = function (by) {
      ...
      return bx
        ? bx.style
          ? parseFloat(b.css(bx, bw, by ? 'margin' : 'border'))
          : this[bw]()
        : null;
    };
    b.fn[bw] = function (bz) {
      ...
      if (b.isWindow(bA)) {
        var bB = bA.document.documentElement['client' + e],
          bx = bA.document.body;
        return (
          (bA.document.compatMode === 'CSS1Compat' && bB) ||
          (bx && bx['client' + e]) ||
          bB
        );
      } else {
        if (bA.nodeType === 9) {
          return Math.max(
            bA.documentElement['client' + e],
            bA.body['scroll' + e],
            bA.documentElement['scroll' + e],
            bA.body['offset' + e],
            bA.documentElement['offset' + e],
          );
        } else {
          if (bz === L) {
            var bC = b.css(bA, bw),
